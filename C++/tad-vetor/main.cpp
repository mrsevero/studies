...
cout << "\n8 - ordenar os elementos do vetor em um segundo vetor (o metodo cria o novovetor,copia os dados e retorna o vetor ordenado";
cout << "\n---------------------";
cout << "\nQual a sua opcao -> ";
int opc;
cin >> opc;
...
int idy;
cin >> idy;
int val = tv.trocar_2_elementos(idx, idy);
system("PAUSE");
}
else if (opc == 5) {
int val = tv.localiza_maior_menor();
system("PAUSE");
} 
else if (opc == 6) {
int val = tv.ordena_crescente();
system("PAUSE");
}
else if (opc == 7) {
int val = tv.ordena_decrescente();
system("PAUSE");
} 
else if (opc == 8) {
int val = tv.ordena_vetor2();
system("PAUSE");
}
}
//system("PAUSE");
